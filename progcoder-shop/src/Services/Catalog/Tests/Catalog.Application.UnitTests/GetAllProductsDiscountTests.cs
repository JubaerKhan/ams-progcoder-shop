...
{
    [Theory]
    [InlineData(4900d, 0d)]     // the incident: zero sale price must not divide by zero
    ...
    public void Handles_a_tiny_nonzero_sale_price_without_an_absurd_badge()
    {
        ...
        // price produced a huge badge percentage rather than a crash. The share
        // of the regular price is capped at 100 by construction, which is the
        // honest description of "almost free".
