...
| Zero sale-price list | `GET /admin/products/all` | `DivideByZeroException` (fails whole list) | `Features/Product/Queries/GetAllProductsQuery.cs` | **fixed** (incident 5, spec-b604db) — badge math no longer divides by `SalePrice` |
